...
가상 계좌로 10개 미국 종목의 **고정 일봉 연습 데이터**를 한 봉씩 공개하며 연습할 수 있습니다.
...
- **기간·재생 속도**: 1개월=30봉, 3개월=90봉, 6개월=180봉, 1년=365봉, 2년=730봉,
  3년=1,095봉으로 고정하며, 최대 기간은 3년입니다. x0.25 / x0.5 / x1 / x2, 한 봉 진행,
  새 시나리오를 지원합니다.
